...
function twentig_twentytwenty_theme_scripts() {
	...
	wp_enqueue_style(
		...
		TWENTIG_ASSETS_URI . "/css/twentytwenty/style{$min}.css",
		array(),
		TWENTIG_VERSION
	);
	...
	if ( get_theme_mod( 'twentig_local_fonts', false ) ) {
		...
		wp_add_inline_style( 'twentig-webfonts', twentig_minify_css( wptt_get_webfont_styles( twentig_twentytwenty_fonts_url() ) ) );
	} else {
