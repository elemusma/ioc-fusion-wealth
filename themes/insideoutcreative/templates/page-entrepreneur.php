...
echo '<h2 class="text-white">Structure Your Plan</h2>';
...
echo '<h2 class="">Founders &amp; Entrepreneurs</h2>';
...
echo '<h2 class="text-white position-relative">Five Things You Need to Know Before<br>Selling Your Business</h2>';
