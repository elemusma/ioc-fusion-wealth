...
echo '<a href="' . esc_url( $link_url ) . '" class="btn btn-effect text-white bg-accent-quaternary d-inline-block position-relative overflow-h mt-4 mb-5" target="' . esc_attr( $link_target ) . '">';
